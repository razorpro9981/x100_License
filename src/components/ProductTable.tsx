  ...
  const renderFilters = () => (
    <React.Fragment>
      <FormControl size="sm">
        ...
        >
          <Option value="paid">#P01</Option>
          <Option value="pending">#P02</Option>
          <Option value="refunded">#P03</Option>
          <Option value="cancelled">#P04</Option>
        </Select>
      </FormControl>
      <FormControl size="sm">
        ...
        >
          <thead>
            <tr>
              ...
              <th style={{ width: 120, padding: "12px 20px" }}>
                <Link
                  underline="none"
                  color="primary"
                  component="button"
              ...
              <th style={{ width: 140, padding: "12px 6px" }}>Stock</th>
